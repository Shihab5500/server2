...
app.post("/api/users", async (req, res) => {
  ...
  // 🛑 [FIX] ইমেল সবসময় ছোট হাতের অক্ষরে সেভ হবে
...
app.get("/api/users/me", verifyJWT, async (req, res) => {
  const db = getDB();
  // 🛑 [FIX] টোকেন থেকে পাওয়া ইমেলও ছোট হাতের করে খোঁজা হবে
...
/* ---------------- DONATION REQUESTS ---------------- */
// (বাকি রাউটগুলোতে ইমেল চেক করার সময় .toLowerCase() ব্যবহার করবেন যদি প্রয়োজন হয়, তবে উপরের পরিবর্তনগুলোই মূল সমস্যা সমাধান করবে)
